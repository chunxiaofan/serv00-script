...
for server in servers:
    ...
    restore_command = f"sshpass -p '{password}' ssh -o StrictHostKeyChecking=no -p {port} {username}@{host} '/home/spd2021/.npm-global/bin/pm2 resurrect'"
    # restore_command = f"sshpass -p '{password}' ssh -o StrictHostKeyChecking=no -p {port} {username}@{host} 'cd /usr/home/spd2021/domains/vless.fanchunxiao.cloudns.ch/vless && ./check_vless.sh'"
    try:
